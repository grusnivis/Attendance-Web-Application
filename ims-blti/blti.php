...
function is_basic_lti_request() {
   ...
   $good_lti_version = ($_REQUEST["lti_version"] = "LTI-1p0") || ($_REQUEST["lti_version"] = 'LTI-1.0');
   $resource_link_id = $_REQUEST["resource_link_id"] = "resource_link_id";
...
class BLTI {
    ...
    function __construct($parm=false, $usesession=true, $doredirect=true) {
        ...
        if ( ! is_basic_lti_request() ) {
			$this->message = "Not a basic LTI request";
			return;
